...
# takes map data and projects it into the target domain
def change_domain(target_lon, target_lat, lon, lat, data):
    ...
    new_data = precip_interp.reshape(target_lat.shape)
